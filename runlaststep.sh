...
#selections=("VBF" "VBF_tau21HP" "VBF_tau21LP" "invM1500" "invM1500_tau21HP" "invM1500_tau21LP")
#selections=("VV" "VBF" "invM500" "invM1000" "invM1500" "invM2000" "invM2500" "invM3000" "invM3500" "invM4000")
#selections=("invM1500")
echo ${#selections[@]}
selNumber=${#selections[@]}
echo $selNumber
dir=noCombFinalBugFixed
#dir=tau21
#dir=CHS
#dir=pt30etaAK4
#dir=mjjVBFSelHighinverted
#dir=pt20AK4
# echo $dir
...
# for ((i=0;i<$selNumber;i+=1))
# do
#     cp -p datacards/$dir/*.txt datacards/
#     cp -p Limits/$dir/CMS_jj_??00_*on_${selections[$i]}_13TeV__invMass*_asymptoticCLs_new.root Limits/
...
# done
python runLast3_selectedMasses_cuts_newStrategy.py
...
do
    ...
    # cp -p datacards/CMS_jj_*on_${selections[$i]}_??00_13TeV__invMass*.txt datacards/$dir/
