...
if 2 in steps:
    for mass in masses:
        os.system('python Limits/CalcAsympLimitsUHH_cuts_unc_rad.py '+str(mass)+' '+str(cut)+' '+str(uncertainty))

if 3 in steps:
    os.system('python Limits/brazilianFlag_theoryUncBand_selectedMasses_cuts_unc_rad.py '+str(cut)+' '+str(uncertainty))
