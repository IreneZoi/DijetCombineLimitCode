    ...
    for category in categories:
     ...
     #           for m in masses_interpolated:
              #print " find mass "+str(m)+ " found : "+str( l.find("%i"%m))
                ...
                PDFaccUP[mass] = PDFaccup
                PDFaccDOWN[mass] = PDFaccdown
        ...
        with open(fname_PDFxs,"r") as PDFxs:
            for l in PDFxs:
                ...
                PDFxsUP[mass] = PDFxsup
                PDFxsDOWN[mass] = PDFxsdown      
        ...
        with open(fname_SCALEacc,"r") as SCALEacc:
            for l in SCALEacc:
                ...
                SCALEaccUP[mass] = SCALEaccup
                SCALEaccDOWN[mass] = SCALEaccdown
...
#                for m in masses_interpolated:
                ...
                SCALExsUP[mass] = SCALExsup
                SCALExsDOWN[mass] = SCALExsdown
...
#        for m in masses_interpolated:
        print ""
        print "Mass = %s: " %(mass)
        print " PDFacc UP/DOWN =    %.4f     %.4f  " %(PDFaccUP[mass],PDFaccDOWN[mass])
        print " PDFxs UP/DOWN =    %.4f     %.4f  " %(PDFxsUP[mass],PDFxsDOWN[mass])
        print " SCALEacc UP/DOWN =    %.4f     %.4f  " %(SCALEaccUP[mass],SCALEaccDOWN[mass])
        print " SCALExs UP/DOWN =    %.4f     %.4f  " %( SCALExsUP[mass],SCALExsDOWN[mass])
