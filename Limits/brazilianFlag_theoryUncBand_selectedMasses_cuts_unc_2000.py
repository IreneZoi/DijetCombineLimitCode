...
#        gr1up.SetPoint(j, radmasses[j], y1up[j])
 #       grmean.SetPoint(j, radmasses[j], ymean[j])
  #      gr1down.SetPoint(j, radmasses[j], y1down[j])    
    ...
    text_file = open("LimitTxt/"+label+"_Limit_Unc_2000.txt", "w")
    text_file.write(" 2000 \n")    
    text_file.write(" {0}  #limit\n".format( str(grmean.Eval(2.0)) )    )
    text_file.write(" {0}  #+1sigma\n".format(  str(gr1up.Eval(2.0)) )    )
    text_file.write(" {0}  #-1sigma\n".format( str(gr1down.Eval(2.0))  )    )
    text_file.close()
    #===============================================================================================
