          ...
          for point in points:
            ...
            if fullToys:
              ...
              outputfile.write("combine datacards/CMS_jj_"+chan+"_"+str(mass)+"_13TeV_"+bin+".txt -M HybridNew --frequentist --grid grid_mX"+str(mass)+"_" + chan + "_13TeV_"+bin+".root -m "+str(mass) + " -n "+chan+str(bin)+" --expectedFromGrid 0.975 &>CMS_jj_"+chan+"_"+str(mass)+"_13TeV_"+bin+"_975_fullCLs.out\n")
                ...
                if uncertainty != "CMS_sig_p1_jes_13TeV" and uncertainty != "CMS_sig_p2_jer_13TeV":
                ...
                if uncertainty == "CMS_sig_p1_jes_13TeV":
                    outputfile.write("combine datacards/CMS_jj_"+chan+"_"+str(cut)+"_"+str(mass)+"_13TeV_"+bin+"_"+str(uncertainty)+".txt -M Asymptotic -v2 -m "+str(mass) + " -n "+chan+str(cut)+str(bin)+"_"+str(uncertainty)+" --rMax 100 --rMin 0.000001 --freezeParameters CMS_sig_p2_jer_13TeV  &>CMS_jj_"+chan+"_"+str(cut)+"_"+str(mass)+"_13TeV_"+bin+"_"+str(uncertainty)+"_asymptoticCLs.out\n")
                    outputfile.write("combine datacards/CMS_jj_"+chan+"_"+str(cut)+"_"+str(mass)+"_13TeV_"+bin+"_"+str(uncertainty)+".txt -M MaxLikelihoodFit --signif -v2 -m "+str(mass) + " -n "+chan+str(cut)+str(mass)+str(bin)+"_"+str(uncertainty)+" --rMax 100 --rMin 0.000001 --plots --out ${CMSSW_BASE}/src/DijetCombineLimitCode/plots --freezeParameters CMS_sig_p2_jer_13TeV  &>CMS_jj_"+chan+"_"+str(mass)+"_13TeV_"+bin+"_"+str(uncertainty)+"_MaxLikelihoodFit.out\n")
                    outputfile.write("mv higgsCombine"+chan+str(cut)+str(bin)+"_"+str(uncertainty)+".Asymptotic.mH"+str(int(mass))+".root Limits/CMS_jj_"+str(mass)+"_"+chan+"_"+str(cut)+"_13TeV_"+bin+"_"+str(uncertainty)+"_asymptoticCLs_new.root")
                if uncertainty == "CMS_sig_p2_jer_13TeV":
                    outputfile.write("combine datacards/CMS_jj_"+chan+"_"+str(cut)+"_"+str(mass)+"_13TeV_"+bin+"_"+str(uncertainty)+".txt -M Asymptotic -v2 -m "+str(mass) + " -n "+chan+str(cut)+str(bin)+"_"+str(uncertainty)+" --rMax 100 --rMin 0.000001 --freezeParameters CMS_sig_p1_jes_13TeV  &>CMS_jj_"+chan+"_"+str(cut)+"_"+str(mass)+"_13TeV_"+bin+"_"+str(uncertainty)+"_asymptoticCLs.out\n")
                    outputfile.write("combine datacards/CMS_jj_"+chan+"_"+str(cut)+"_"+str(mass)+"_13TeV_"+bin+"_"+str(uncertainty)+".txt -M MaxLikelihoodFit --signif -v2 -m "+str(mass) + " -n "+chan+str(cut)+str(mass)+str(bin)+"_"+str(uncertainty)+" --rMax 100 --rMin 0.000001 --plots --out ${CMSSW_BASE}/src/DijetCombineLimitCode/plots --freezeParameters CMS_sig_p1_jes_13TeV  &>CMS_jj_"+chan+"_"+str(mass)+"_13TeV_"+bin+"_"+str(uncertainty)+"_MaxLikelihoodFit.out\n")
                    outputfile.write("mv higgsCombine"+chan+str(cut)+str(bin)+"_"+str(uncertainty)+".Asymptotic.mH"+str(int(mass))+".root Limits/CMS_jj_"+str(mass)+"_"+chan+"_"+str(cut)+"_13TeV_"+bin+"_"+str(uncertainty)+"_asymptoticCLs_new.root")
