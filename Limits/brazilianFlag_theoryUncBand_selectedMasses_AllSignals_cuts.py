...
#    frame.GetYaxis().SetTitle("#sigma_{95%} #times BR("+resonance+" #rightarrow WW"+label.split("_")[0].replace("graviton","").replace("radion","")+") (pb)") #irene 
    frame.GetYaxis().SetTitle("#sigma_{95%} (pp #rightarrow "+resonance+"jj #rightarrow WWjj"+label.split("_")[0].replace("graviton","").replace("radion","").replace("wprime","").replace("zprime","")+") (pb)") #irene 
